...
//*****************************************************************************
// string
const D3DXVECTOR2 DEFAULT_SIZE = D3DXVECTOR2(Option::DEFAULT_MENU_SIZE.x * 1.2f, Option::DEFAULT_MENU_SIZE.y);
...
bool KeyConfigCancel::Initialize(void)
{
	...
	cancel_button_frame_->__size(Option::DEFAULT_MENU_FRAME_SIZE);
