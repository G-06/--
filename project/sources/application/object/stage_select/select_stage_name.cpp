...
const D3DXVECTOR2 StageName::DEFAULT_POSITION = D3DXVECTOR2(DEFAULT_SCREEN_WIDTH * 0.5f,85);
const D3DXVECTOR2 StageName::DEFAULT_SIZE = D3DXVECTOR2(512.0f,128.0f);
