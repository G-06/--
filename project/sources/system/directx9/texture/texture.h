...
public:
	enum TEXTURE_ID
	{
		...
		TEXTURE_ID_OPTION_NUMBER_FRAME,
		...
		TEXTURE_ID_GAME_GOAL_POINT_LUMINESCENCE,
		...
		TEXTURE_ID_GAME_STRING_GAME_OVER,
		...
		TEXTURE_ID_PAUSE_STRING_PAUSE_RETRY,
		TEXTURE_ID_PAUSE_STRING_PAUSE_SELECT_BACK,
		TEXTURE_ID_PAUSE_STRUNG_CONFIRM_RETRY,
